from torchdata.dataloader2 import DataLoader2, MultiProcessingReadingService, PrototypeMultiProcessingReadingService, Prototype2MultiProcessingReadingService
    ...
    def thread_worker(prefetch_data):
        ...
        while prefetch_data.run_prefetcher:
            if len(prefetch_data.prefetch_buffer) < prefetch_data.prefetch and not stop_iteration:
                ...
                except (RuntimeError, StopIteration): # TODO(VitalyFedyunin): Instead of general exception catch invalid iterator here
                    stop_iteration = True
...
def main():
    ...
    speed = items / total
    print("{} items per sec".format(speed))
