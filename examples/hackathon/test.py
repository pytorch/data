...
import torcharrow_wrapper
from torcharrow import functional
import torcharrow.pytorch as tap

# from prototype import DataLoader2, MultiProcessingReadingService
...
from torch.utils.data.datapipes.dataframe.dataframes import CaptureLikeMock, disable_capture
...
# TODO(VitalyFedyunin): Optimize this operation as part of hackathon follow-up
df = df.shuffle()
...
conversion = {
        ...
        "sparse_features": tap.rec.Dense(), # Sparse not implemented yet
        # Because labesl are unlisted it works like "labels": tap.rec.Default(),
    }
...
# Repeat (aka wrap around) proposal (as DataPipe and Adapter)
# from torchdata.graph.adapters import Repeat, DisableShuffle, FullSync

# dl = DataLoader2(df, 
#                 #  datapipe_adapter_fn = (Repeat(target_elements = 10000),
#                 #                         DisableShuffle(),
#                 #                         FullSync()), 
#                  reading_service = reading_service)

# Similar to 
# dl = DataLoader2(df.repeat(target_elements = 10000),  
#                  reading_service = reading_service)
