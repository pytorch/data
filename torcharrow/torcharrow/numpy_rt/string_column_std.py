...
# TODO: for now we also just use the same code for the CPU...
# this is only temporary --> delete eventually
ColumnFactory.register((dt.String.typecode + "_empty", "cpu"), StringColumnStd._empty)
ColumnFactory.register((dt.String.typecode + "_full", "cpu"), StringColumnStd._full)
