...
from .dtypes import NL, Boolean, Field, Int64, List_, String, Struct, is_string, string
...
class StringMethods:
    ...
    def isalnum(self):
        return self._map_boolean(str.isalnum)

    def isalpha(self):
        return self._map_boolean(str.isalpha)

    def isascii(self):
        return self._map_boolean(str.isascii)

    def isdecimal(self):
        return self._map_boolean(str.isdecimal)

    def isdigit(self):
        return self._map_boolean(str.isdigit)

    def isidentifier(self):
        return self._map_boolean(str.isidentifier)

    def islower(self):
        return self._map_boolean(str.islower)

    def isnumeric(self):
        return self._map_boolean(str.isnumeric)

    def isprintable(self):
        return self._map_boolean(str.isprintable)

    def isspace(self):
        return self._map_boolean(str.isspace)

    def istitle(self):
        return self._map_boolean(str.istitle)

    def isupper(self):
        return self._map_boolean(str.isupper)
