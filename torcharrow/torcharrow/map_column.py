...
from typing import (TypeVar, Union, Optional, List, Dict, ClassVar, Callable, Any, Literal)

from .tabulate import tabulate

from torcharrow.dtypes import DType, List_, is_map, NL
...
class MapMethods:
    ...
    def get(self, i, fill_value):  
        me = self._parent  
        fun = lambda xs: xs.get(i,fill_value)
