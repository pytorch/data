...
class _Functional(ModuleType):
    ...
    def __init__(self):
        ...
        self._registered_functions: Dict[str, FunctionHandle] = {}
    ...
    def register_function(self, udf_name: str, fn: Callable, signatures: List[FunctionSignature], alias: Optional[str] = None):
        ...
        function = Functional(udf_name, alias, fn)
        self._registered_functions[alias] = FunctionHandle(function, signatures)
        setattr(self, alias, function)

    def __getattr__(self, key: str) -> Functional:
        return self.__dict__[key]

    @property
    def registered_functions(self) -> Dict[str, FunctionHandle]:
